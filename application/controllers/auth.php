		...
		if ($this->input->post('btnRegister')){
			...
			if ($this->form_validation->run()){
                ...
                if ($arr->success) {
                    ...
                    $this->email->from('admin@compushop.hol.es', 'Admin My Compu-Shop');
                    $this->email->subject('Welcome to My Compu-Shop');
                    ...
                    if ($this->email->send()) {
                        ...
                        if ($success) {
                            ...
                            $this->session->set_flashdata('alert', '<strong>Menunggu Verifikasi Email Anda!</strong><br/>Terima kasih telah bergabung dengan My Compu-Shop');
                            $this->email->to($this->input->post('email'));
                            $this->email->from('admin@compushop.hol.es', 'Admin My Compu-Shop');
                            $data['link'] = anchor('auth/activate?key=' . $success, 'Activate Your Account Now');
                            $this->email->subject('Confirm your account | My Compu-Shop');
...
//                        echo $this->email->print_debugger();
        ...
        $data['title'] = "Register to My Compu-Shop";
    ...
    public function login(){
        $data['title'] = "Login to My Compu-Shop";
        $this->load->helper('form');
        $this->load->view('header',$data);
